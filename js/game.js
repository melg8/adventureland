...
function init_socket(args)
{
	...
	if(is_sdk && (Cookies.get("windows") || Cookies.get("local_ip") || window.location.host=="advanture.land" || window.location.host=="x.thegame.com")) 
	{
		server_addr="192.168.1.125"; // Cookies.set('windows','1',{expires:12*365});
	}
	else if(is_sdk)
	{
		console.log('SDK MODE wss server adress:', window.location.hostname)
